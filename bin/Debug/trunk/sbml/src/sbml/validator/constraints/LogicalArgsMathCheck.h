 ...
 *
 * $Id: LogicalArgsMathCheck.h 56 2011-10-05 21:20:52Z dchandran1@gmail.com $
 * $HeadURL: https://copasi-simple-api.googlecode.com/svn/trunk/sbml/src/sbml/validator/constraints/LogicalArgsMathCheck.h $
 *
 * <!--------------------------------------------------------------------------
...
#ifndef LogicalArgsMathCheck_h
#define LogicalArgsMathCheck_h
...
class LogicalArgsMathCheck: public MathMLBase
{
public:
   ...
   */
  LogicalArgsMathCheck (unsigned int id, Validator& v);

  /**
   * Destroys this Constraint.
   */
  virtual ~LogicalArgsMathCheck ();
